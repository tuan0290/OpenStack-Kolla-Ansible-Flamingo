...
├── 03-globals-inventory.md     → Bastion
├── 04-deploy.md                → Bastion
├── 05-post-deploy.md           → Bastion + Controller
├── 06-cinder.md                → Bastion + Storage1
├── 07-swift.md                 → Bastion + Object1 + Object2
├── 08-heat.md                  → Bastion
├── 09-octavia.md               → Bastion
└── 10-ceilometer.md            → Bastion
```

| File | Nội dung | Node |
|---|---|---|
| [01-environment-prepare.md](01-environment-prepare.md) | Chuẩn bị OS, network, SSH key | Tất cả nodes |
| [02-kolla-ansible-setup.md](02-kolla-ansible-setup.md) | Cài Kolla-Ansible, Python venv | Bastion |
| [03-globals-inventory.md](03-globals-inventory.md) | Cấu hình globals.yml, inventory | Bastion |
| [04-deploy.md](04-deploy.md) | Bootstrap, prechecks, deploy | Bastion |
| [05-post-deploy.md](05-post-deploy.md) | Post-deploy, tạo network, launch instance | Bastion |
| [06-cinder.md](06-cinder.md) | Block Storage (LVM) | Bastion + Storage1 |
| [07-swift.md](07-swift.md) | Object Storage | Bastion + Object1/2 |
| [08-heat.md](08-heat.md) | Orchestration | Bastion |
| [09-octavia.md](09-octavia.md) | Load Balancer | Bastion |
| [10-ceilometer.md](10-ceilometer.md) | Telemetry | Bastion |
